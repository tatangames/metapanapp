...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin2/denuncia-histo-electrico/completada/listado-tabla') }}";
    ...
    <script>
        ...
        function verMapa(id){
            window.location.href="{{ url('/admin2/denuncia-histo-electrico/mapa/') }}/"+id;
        }
        ...
        function verImagen(id){
            ...
            axios.post('/admin2/denuncia-histo-electrico/ver-imagen',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
