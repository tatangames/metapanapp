        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Estados para Denuncias</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Estado Denuncia</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="api-editar">
                                    </div>

                                    <div class="form-group">
                                        <label>Nombre WEB</label>
                                        <input type="text" maxlength="100" class="form-control" id="web-editar">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/estadodenuncia/listado-tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/estadodenuncia/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post('/admin/estadodenuncia/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            if(nombreapi.length > 100){
                toastMensaje('error', 'Máximo 100 caracteres para Nombre API');
                return;
            }
            ...
            if(nombreweb.length > 100){
                toastMensaje('error', 'Máximo 100 caracteres para Nombre WEB');
                return;
            }
            ...
            axios.post('/admin/estadodenuncia/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
