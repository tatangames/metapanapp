...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var id = {{ $id }};
            var ruta = "{{ url('/admin/listadenuncia/multiple/listado-tabla') }}/"+id;
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post('/admin/listadenuncia/multiple/listado-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading()
        ...
        function modalInformacion(id){
            ...
            axios.post('/admin/listadenuncia/multiple/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/listadenuncia/multiple/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
