                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="125" class="form-control" id="descripcion-nuevo">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input type="text" maxlength="125" class="form-control" id="descripcion-editar">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/tiposervicio/listado-tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            if(descripcion.length > 125){
                toastMensaje('error', '125 caracteres máximo para Descripción');
                return;
            }
            ...
            axios.post('/admin/tiposervicio/listado-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading()
        ...
        function recargar(){
            var ruta = "{{ url('/admin/tiposervicio/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post('/admin/tiposervicio/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/tiposervicio/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
