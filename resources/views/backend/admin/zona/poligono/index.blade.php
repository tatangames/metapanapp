...
<section class="content-header">
    <div class="container-fluid">
        <h1>Zona: {{ $nombre }}</h1>
        <br>
        <button type="button" onclick="abrirModalBorrar()" class="btn btn-danger btn-sm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Borrar Poligonos</h4>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-danger" onclick="borrarPoligonos()">Borrar</button>
            </div>
        </div>
    </div>
</div>
...
@section('archivos-js')
    ...
    <script>
        ...
        function guardarRegistro(){
            ...
            axios.post('/admin/zona/poligono/listado-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrarPoligonos(){
            ...
            axios.post('/admin/zona/poligono/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
