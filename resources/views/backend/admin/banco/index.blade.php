                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="comision-editar">
                                    </div>
                                    <hr>

                                    <div class="form-group" style="margin-left:20px">
                                        <label>Estado para Formularios</label><br>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/banco/listado-tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/banco/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post('/admin/banco/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            if(!comision.match(reglaNumeroDecimal)) {
                toastMensaje('error', 'Comisión no es válido');
                return;
            }

            // maximo de comision
            if(comision > 10){
                toastMensaje('error', 'máximo 10 para Comisión');
                return;
            }
            ...
            axios.post('/admin/banco/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
